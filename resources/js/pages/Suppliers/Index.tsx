...
export default function SupplierIndex() {
        ...
        cell: ({ row }) => (
          <div className="flex justify-end gap-2">
            ...
            <Button
              ...
              disabled={!!(row.original.products_count || row.original.orders_count)}
              title={
                row.original.products_count || row.original.orders_count
  ...
  const CampusCombobox = ({
    ...
    const options = [
      { value: "1", label: "Yes (Campus)" },
      { value: "0", label: "No (External)" },
    ];
          ...
          <DialogContent className="sm:max-w-[540px]">
            ...
            <form onSubmit={(e) => handleSubmit(e, editOpen)} className="space-y-6 py-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label>Campus Supplier?</Label>
                  <CampusCombobox
                    value={form.data.is_campus}
                    onChange={(v) => form.setData("is_campus", v)}
                  />
                </div>
              </div>
